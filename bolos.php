...
<div class="conteudo">
    <div class="breadCrumbs">
        <button class="btn btn-formiga text-formiga breadItem bt_adicionar_base" data-tipo="BOL">Adicionar Tabela</button>
        <input type="search" class="form-control breadItem" placeholder="Pesquisar.." name="pesquisaProdutos">
    </div>
    <div id="accordion">
    <?php
    foreach(Categorias::getBases("BOL") as $b){
    ?>
        <div class="card" data-id='<?=$b['IDCategoria']?>'>
            ...
            <h5 class="mb-0 voltaOlimpica">
                ...
                <div>
                    <button class="btn btn-sm text-formiga bt-adicionar-bolo" data-categoria='<?=$b['IDCategoria']?>' data-tipocategoria="BOL" style="background:pink">Adicionar Bolo</button>
