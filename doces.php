...
<div class="conteudo">
    <div class="breadCrumbs">
        <button class="btn btn-formiga text-formiga breadItem bt_adicionar_base" data-tipo="DOC">Adicionar Tipo</button>
        <input type="search" class="form-control breadItem" placeholder="Pesquisar.." name="pesquisaProdutos">
    </div>
    <div id="accordion">
    <?php
    foreach(Categorias::getBases("DOC") as $b){
    ?>
        <div class="card" data-id='<?=$b['IDCategoria']?>'>
            ...
            <h5 class="mb-0 voltaOlimpica">
                ...
                <div>
                    <button class="btn btn-sm text-formiga bt-adicionar-bolo" data-categoria='<?=$b['IDCategoria']?>' data-tipocategoria="DOC" style="background:pink">Adicionar Doces</button>
